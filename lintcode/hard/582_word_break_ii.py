            ...
            if mid == end:
                ...
                for interm_sentence in intermediate_sentences:
                    for cont_sentence in continuing_sentences:
                        ...
                        # If we don't filter here, there'd be duplicates. For example, interm_sentence can be "lint", cont_sentence 
                        # can be "co de"; interm_sentence can also be "lint co", cont_sentence is "de". Both are valid and will result in duplicates.
