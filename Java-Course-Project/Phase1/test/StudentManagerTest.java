...
public class StudentManagerTest {
	...
	public void testTwoStudents(){
		try{
			manager.parseSchedules("data/Schedules.xml");
			Student student1 = manager.get(123456);
			assertTrue(student1.getLastName().equals("Seed"));
			assertTrue(student1.getFirstName().equals("Apple"));
			Schedule schedule = student1.getSchedule();
			assertTrue(schedule.startTime("MWF").equals(new CourseTime("10:00","10:50")));
			
			Student student2 = manager.get(513456);
			assertTrue(student2.getLastName().equals("Sauce"));
			assertTrue(student2.getFirstName().equals("Pepper"));
			schedule = student2.getSchedule();
			assertTrue(schedule.startTime("MWF").equals(new CourseTime("10:00","10:50")));
