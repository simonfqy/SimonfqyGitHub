...
public class CourseTime implements Comparable<CourseTime> {
	 ...
	 * Effects: return start time as HH:MM
	 */
	...
	@Override
	/**
	 * Returns 1 if this starttime is later than the parameter's starttime,
	 * return 0 if the two are equal, and return -1 if this starttime is
	 * earlier than the parameter's starttime.
	 */
